...
static const char *colors[][3]      = {
    ...
    [SchemeSel]  = { col_fg, col_sel,  col_purple  },
};

/* tagging */
static const char *tags[] = { "", "󰖟", "", "󰻞", "" };
...
static const char *powercmd[] = { "bash", "/home/athrail/.config/scripts/power.sh", NULL };
static const char *browsercmd[] = { "flatpak", "run", "com.brave.Browser", NULL };
static const char *thunarcmd[] = { "thunar" , "/home/athrail", NULL };
...
static const char *light_up[] = {"/usr/bin/light", "-s", "sysfs/backlight/intel_backlight", "-A", "5", NULL};
static const char *light_down[] = {"/usr/bin/light", "-s", "sysfs/backlight/intel_backlight", "-U", "5", NULL};
...
static const Key keys[] = {
    ...
    { MODKEY|ControlMask,	        XK_p,      spawn,          {.v = powercmd } },
